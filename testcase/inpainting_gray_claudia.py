...
def main():
    ...
    image = cv2.imread("claudiamasked1.png", 0)
    orimg = cv2.resize(orimg,(256,254))
    image = cv2.resize(image,(256,254))
    ...
    cv2.imwrite("claudiamasked1.png".split(".")[0]+"inpainting.png", inpainting_image.astype('uint8'))
